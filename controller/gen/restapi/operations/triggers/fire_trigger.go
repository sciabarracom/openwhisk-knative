...
type FireTriggerHandlerFunc func(FireTriggerParams, *models.Auth) middleware.Responder

// Handle executing the request and returning a response
func (fn FireTriggerHandlerFunc) Handle(params FireTriggerParams, principal *models.Auth) middleware.Responder {
	return fn(params, principal)
}

// FireTriggerHandler interface for that can handle valid fire trigger params
type FireTriggerHandler interface {
	Handle(FireTriggerParams, *models.Auth) middleware.Responder
}
