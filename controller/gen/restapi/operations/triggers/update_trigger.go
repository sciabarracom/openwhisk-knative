...
type UpdateTriggerHandlerFunc func(UpdateTriggerParams, *models.Auth) middleware.Responder

// Handle executing the request and returning a response
func (fn UpdateTriggerHandlerFunc) Handle(params UpdateTriggerParams, principal *models.Auth) middleware.Responder {
	return fn(params, principal)
}

// UpdateTriggerHandler interface for that can handle valid update trigger params
type UpdateTriggerHandler interface {
	Handle(UpdateTriggerParams, *models.Auth) middleware.Responder
}
