...
type GetTriggerByNameHandlerFunc func(GetTriggerByNameParams, *models.Auth) middleware.Responder

// Handle executing the request and returning a response
func (fn GetTriggerByNameHandlerFunc) Handle(params GetTriggerByNameParams, principal *models.Auth) middleware.Responder {
...
type GetTriggerByNameHandler interface {
	Handle(GetTriggerByNameParams, *models.Auth) middleware.Responder
}
