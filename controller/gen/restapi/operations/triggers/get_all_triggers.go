...
type GetAllTriggersHandlerFunc func(GetAllTriggersParams, *models.Auth) middleware.Responder

// Handle executing the request and returning a response
func (fn GetAllTriggersHandlerFunc) Handle(params GetAllTriggersParams, principal *models.Auth) middleware.Responder {
...
type GetAllTriggersHandler interface {
	Handle(GetAllTriggersParams, *models.Auth) middleware.Responder
}
