...
type GetAllNamespacesHandlerFunc func(GetAllNamespacesParams, *models.Auth) middleware.Responder

// Handle executing the request and returning a response
func (fn GetAllNamespacesHandlerFunc) Handle(params GetAllNamespacesParams, principal *models.Auth) middleware.Responder {
...
type GetAllNamespacesHandler interface {
	Handle(GetAllNamespacesParams, *models.Auth) middleware.Responder
}
