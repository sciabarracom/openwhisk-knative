...
type SetStateHandlerFunc func(SetStateParams, *models.Auth) middleware.Responder

// Handle executing the request and returning a response
func (fn SetStateHandlerFunc) Handle(params SetStateParams, principal *models.Auth) middleware.Responder {
	return fn(params, principal)
}

// SetStateHandler interface for that can handle valid set state params
type SetStateHandler interface {
	Handle(SetStateParams, *models.Auth) middleware.Responder
}
