...
func (o *GetAllRulesURL) Build() (*url.URL, error) {
	...
	var _path = "/namespaces/{namespace}/rules"

	namespace := o.Namespace
	if namespace != "" {
		_path = strings.Replace(_path, "{namespace}", namespace, -1)
	} else {
		return nil, errors.New("namespace is required on GetAllRulesURL")
	}
...
func (o *GetAllRulesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetAllRulesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetAllRulesURL")
	}
