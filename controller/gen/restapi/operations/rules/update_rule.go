...
type UpdateRuleHandlerFunc func(UpdateRuleParams, *models.Auth) middleware.Responder

// Handle executing the request and returning a response
func (fn UpdateRuleHandlerFunc) Handle(params UpdateRuleParams, principal *models.Auth) middleware.Responder {
	return fn(params, principal)
}

// UpdateRuleHandler interface for that can handle valid update rule params
type UpdateRuleHandler interface {
	Handle(UpdateRuleParams, *models.Auth) middleware.Responder
}
