...
func (o *DeleteWebNamespacePackageNameActionNameExtensionDefault) WithPayload(payload interface{}) *DeleteWebNamespacePackageNameActionNameExtensionDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete web namespace package name action name extension default response
func (o *DeleteWebNamespacePackageNameActionNameExtensionDefault) SetPayload(payload interface{}) {
	o.Payload = payload
}
