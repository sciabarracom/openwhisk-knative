...
type GetAllActionsHandlerFunc func(GetAllActionsParams, *models.Auth) middleware.Responder

// Handle executing the request and returning a response
func (fn GetAllActionsHandlerFunc) Handle(params GetAllActionsParams, principal *models.Auth) middleware.Responder {
	return fn(params, principal)
}

// GetAllActionsHandler interface for that can handle valid get all actions params
type GetAllActionsHandler interface {
	Handle(GetAllActionsParams, *models.Auth) middleware.Responder
}
