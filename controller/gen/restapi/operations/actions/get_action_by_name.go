...
type GetActionByNameHandlerFunc func(GetActionByNameParams, *models.Auth) middleware.Responder

// Handle executing the request and returning a response
func (fn GetActionByNameHandlerFunc) Handle(params GetActionByNameParams, principal *models.Auth) middleware.Responder {
...
type GetActionByNameHandler interface {
	Handle(GetActionByNameParams, *models.Auth) middleware.Responder
}
