...
type InvokeActionInPackageHandlerFunc func(InvokeActionInPackageParams, *models.Auth) middleware.Responder

// Handle executing the request and returning a response
func (fn InvokeActionInPackageHandlerFunc) Handle(params InvokeActionInPackageParams, principal *models.Auth) middleware.Responder {
...
type InvokeActionInPackageHandler interface {
	Handle(InvokeActionInPackageParams, *models.Auth) middleware.Responder
}
