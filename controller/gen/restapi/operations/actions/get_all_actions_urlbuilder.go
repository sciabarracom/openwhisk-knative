...
func (o *GetAllActionsURL) Build() (*url.URL, error) {
	...
	var _path = "/namespaces/{namespace}/actions"

	namespace := o.Namespace
	if namespace != "" {
		_path = strings.Replace(_path, "{namespace}", namespace, -1)
	} else {
		return nil, errors.New("namespace is required on GetAllActionsURL")
	}
...
func (o *GetAllActionsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetAllActionsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetAllActionsURL")
	}
