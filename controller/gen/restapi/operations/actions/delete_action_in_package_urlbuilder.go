...
func (o *DeleteActionInPackageURL) WithBasePath(bp string) *DeleteActionInPackageURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteActionInPackageURL) Build() (*url.URL, error) {
	...
	if actionName != "" {
		...
		return nil, errors.New("actionName is required on DeleteActionInPackageURL")
	}
	...
	if namespace != "" {
		...
		return nil, errors.New("namespace is required on DeleteActionInPackageURL")
	}
	...
	if packageName != "" {
		...
		return nil, errors.New("packageName is required on DeleteActionInPackageURL")
	}
...
func (o *DeleteActionInPackageURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteActionInPackageURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteActionInPackageURL")
	}
