...
type DeleteActionInPackageHandlerFunc func(DeleteActionInPackageParams, *models.Auth) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteActionInPackageHandlerFunc) Handle(params DeleteActionInPackageParams, principal *models.Auth) middleware.Responder {
...
type DeleteActionInPackageHandler interface {
	Handle(DeleteActionInPackageParams, *models.Auth) middleware.Responder
}
