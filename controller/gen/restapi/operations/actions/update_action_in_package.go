...
type UpdateActionInPackageHandlerFunc func(UpdateActionInPackageParams, *models.Auth) middleware.Responder

// Handle executing the request and returning a response
func (fn UpdateActionInPackageHandlerFunc) Handle(params UpdateActionInPackageParams, principal *models.Auth) middleware.Responder {
...
type UpdateActionInPackageHandler interface {
	Handle(UpdateActionInPackageParams, *models.Auth) middleware.Responder
}
