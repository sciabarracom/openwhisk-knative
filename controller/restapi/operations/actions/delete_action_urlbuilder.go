...
func (o *DeleteActionURL) Build() (*url.URL, error) {
	...
	if actionName != "" {
		...
		return nil, errors.New("actionName is required on DeleteActionURL")
	}
	...
	if namespace != "" {
		...
		return nil, errors.New("namespace is required on DeleteActionURL")
	}
...
func (o *DeleteActionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteActionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteActionURL")
	}
