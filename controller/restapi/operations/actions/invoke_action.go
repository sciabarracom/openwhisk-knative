...
type InvokeActionHandlerFunc func(InvokeActionParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn InvokeActionHandlerFunc) Handle(params InvokeActionParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// InvokeActionHandler interface for that can handle valid invoke action params
type InvokeActionHandler interface {
	Handle(InvokeActionParams, interface{}) middleware.Responder
}
