...
type DeleteActionInPackageHandlerFunc func(DeleteActionInPackageParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteActionInPackageHandlerFunc) Handle(params DeleteActionInPackageParams, principal interface{}) middleware.Responder {
...
type DeleteActionInPackageHandler interface {
	Handle(DeleteActionInPackageParams, interface{}) middleware.Responder
}
