...
func (o *PostWebNamespacePackageNameActionNameExtensionDefault) WithPayload(payload interface{}) *PostWebNamespacePackageNameActionNameExtensionDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the post web namespace package name action name extension default response
func (o *PostWebNamespacePackageNameActionNameExtensionDefault) SetPayload(payload interface{}) {
	o.Payload = payload
}
