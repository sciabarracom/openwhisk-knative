...
type DeleteActionHandlerFunc func(DeleteActionParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteActionHandlerFunc) Handle(params DeleteActionParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// DeleteActionHandler interface for that can handle valid delete action params
type DeleteActionHandler interface {
	Handle(DeleteActionParams, interface{}) middleware.Responder
}
