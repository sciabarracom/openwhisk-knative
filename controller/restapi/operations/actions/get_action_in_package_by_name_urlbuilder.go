...
func (o *GetActionInPackageByNameURL) WithBasePath(bp string) *GetActionInPackageByNameURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetActionInPackageByNameURL) Build() (*url.URL, error) {
	...
	if actionName != "" {
		...
		return nil, errors.New("actionName is required on GetActionInPackageByNameURL")
	}
	...
	if namespace != "" {
		...
		return nil, errors.New("namespace is required on GetActionInPackageByNameURL")
	}
	...
	if packageName != "" {
		...
		return nil, errors.New("packageName is required on GetActionInPackageByNameURL")
	}
...
func (o *GetActionInPackageByNameURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetActionInPackageByNameURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetActionInPackageByNameURL")
	}
