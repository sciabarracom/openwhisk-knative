...
type UpdateActionHandlerFunc func(UpdateActionParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn UpdateActionHandlerFunc) Handle(params UpdateActionParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// UpdateActionHandler interface for that can handle valid update action params
type UpdateActionHandler interface {
	Handle(UpdateActionParams, interface{}) middleware.Responder
}
