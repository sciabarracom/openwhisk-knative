...
type GetActionByNameHandlerFunc func(GetActionByNameParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetActionByNameHandlerFunc) Handle(params GetActionByNameParams, principal interface{}) middleware.Responder {
...
type GetActionByNameHandler interface {
	Handle(GetActionByNameParams, interface{}) middleware.Responder
}
