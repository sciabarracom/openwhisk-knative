...
type UpdateActionInPackageHandlerFunc func(UpdateActionInPackageParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn UpdateActionInPackageHandlerFunc) Handle(params UpdateActionInPackageParams, principal interface{}) middleware.Responder {
...
type UpdateActionInPackageHandler interface {
	Handle(UpdateActionInPackageParams, interface{}) middleware.Responder
}
