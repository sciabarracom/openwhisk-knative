...
type GetAllActionsHandlerFunc func(GetAllActionsParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetAllActionsHandlerFunc) Handle(params GetAllActionsParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// GetAllActionsHandler interface for that can handle valid get all actions params
type GetAllActionsHandler interface {
	Handle(GetAllActionsParams, interface{}) middleware.Responder
}
