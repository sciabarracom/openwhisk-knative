...
type DeleteWebNamespacePackageNameActionNameExtensionHandlerFunc func(DeleteWebNamespacePackageNameActionNameExtensionParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteWebNamespacePackageNameActionNameExtensionHandlerFunc) Handle(params DeleteWebNamespacePackageNameActionNameExtensionParams, principal interface{}) middleware.Responder {
...
type DeleteWebNamespacePackageNameActionNameExtensionHandler interface {
	Handle(DeleteWebNamespacePackageNameActionNameExtensionParams, interface{}) middleware.Responder
}
