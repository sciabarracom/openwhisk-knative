...
type GetAllNamespacesHandlerFunc func(GetAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetAllNamespacesHandlerFunc) Handle(params GetAllNamespacesParams, principal interface{}) middleware.Responder {
...
type GetAllNamespacesHandler interface {
	Handle(GetAllNamespacesParams, interface{}) middleware.Responder
}
