...
func NewOpenWhiskRESTAPI(spec *loads.Document) *OpenWhiskRESTAPI {
	return &OpenWhiskRESTAPI{
		...
		ActionsDeleteWebNamespacePackageNameActionNameExtensionHandler: actions.DeleteWebNamespacePackageNameActionNameExtensionHandlerFunc(func(params actions.DeleteWebNamespacePackageNameActionNameExtensionParams, principal interface{}) middleware.Responder {
		...
		ActionsGetWebNamespacePackageNameActionNameExtensionHandler: actions.GetWebNamespacePackageNameActionNameExtensionHandlerFunc(func(params actions.GetWebNamespacePackageNameActionNameExtensionParams, principal interface{}) middleware.Responder {
		...
		ActionsPostWebNamespacePackageNameActionNameExtensionHandler: actions.PostWebNamespacePackageNameActionNameExtensionHandlerFunc(func(params actions.PostWebNamespacePackageNameActionNameExtensionParams, principal interface{}) middleware.Responder {
		...
		ActionsPutWebNamespacePackageNameActionNameExtensionHandler: actions.PutWebNamespacePackageNameActionNameExtensionHandlerFunc(func(params actions.PutWebNamespacePackageNameActionNameExtensionParams, principal interface{}) middleware.Responder {
		...
		ActionsDeleteActionHandler: actions.DeleteActionHandlerFunc(func(params actions.DeleteActionParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation ActionsDeleteAction has not yet been implemented")
		}),
		ActionsDeleteActionInPackageHandler: actions.DeleteActionInPackageHandlerFunc(func(params actions.DeleteActionInPackageParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation ActionsDeleteActionInPackage has not yet been implemented")
		}),
		PackagesDeletePackageHandler: packages.DeletePackageHandlerFunc(func(params packages.DeletePackageParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation PackagesDeletePackage has not yet been implemented")
		}),
		RulesDeleteRuleHandler: rules.DeleteRuleHandlerFunc(func(params rules.DeleteRuleParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation RulesDeleteRule has not yet been implemented")
		}),
		TriggersDeleteTriggerHandler: triggers.DeleteTriggerHandlerFunc(func(params triggers.DeleteTriggerParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation TriggersDeleteTrigger has not yet been implemented")
		}),
		TriggersFireTriggerHandler: triggers.FireTriggerHandlerFunc(func(params triggers.FireTriggerParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation TriggersFireTrigger has not yet been implemented")
		}),
		ActionsGetActionByNameHandler: actions.GetActionByNameHandlerFunc(func(params actions.GetActionByNameParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation ActionsGetActionByName has not yet been implemented")
		}),
		ActionsGetActionInPackageByNameHandler: actions.GetActionInPackageByNameHandlerFunc(func(params actions.GetActionInPackageByNameParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation ActionsGetActionInPackageByName has not yet been implemented")
		}),
		ActivationsGetActivationByIDHandler: activations.GetActivationByIDHandlerFunc(func(params activations.GetActivationByIDParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation ActivationsGetActivationByID has not yet been implemented")
		}),
		ActivationsGetActivationLogsHandler: activations.GetActivationLogsHandlerFunc(func(params activations.GetActivationLogsParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation ActivationsGetActivationLogs has not yet been implemented")
		}),
		ActivationsGetActivationResultHandler: activations.GetActivationResultHandlerFunc(func(params activations.GetActivationResultParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation ActivationsGetActivationResult has not yet been implemented")
		}),
		ActivationsGetActivationsHandler: activations.GetActivationsHandlerFunc(func(params activations.GetActivationsParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation ActivationsGetActivations has not yet been implemented")
		}),
		ActionsGetAllActionsHandler: actions.GetAllActionsHandlerFunc(func(params actions.GetAllActionsParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation ActionsGetAllActions has not yet been implemented")
		}),
		NamespacesGetAllNamespacesHandler: namespaces.GetAllNamespacesHandlerFunc(func(params namespaces.GetAllNamespacesParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation NamespacesGetAllNamespaces has not yet been implemented")
		}),
		PackagesGetAllPackagesHandler: packages.GetAllPackagesHandlerFunc(func(params packages.GetAllPackagesParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation PackagesGetAllPackages has not yet been implemented")
		}),
		RulesGetAllRulesHandler: rules.GetAllRulesHandlerFunc(func(params rules.GetAllRulesParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation RulesGetAllRules has not yet been implemented")
		}),
		TriggersGetAllTriggersHandler: triggers.GetAllTriggersHandlerFunc(func(params triggers.GetAllTriggersParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation TriggersGetAllTriggers has not yet been implemented")
		}),
		PackagesGetPackageByNameHandler: packages.GetPackageByNameHandlerFunc(func(params packages.GetPackageByNameParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation PackagesGetPackageByName has not yet been implemented")
		}),
		RulesGetRuleByNameHandler: rules.GetRuleByNameHandlerFunc(func(params rules.GetRuleByNameParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation RulesGetRuleByName has not yet been implemented")
		}),
		TriggersGetTriggerByNameHandler: triggers.GetTriggerByNameHandlerFunc(func(params triggers.GetTriggerByNameParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation TriggersGetTriggerByName has not yet been implemented")
		}),
		ActionsInvokeActionHandler: actions.InvokeActionHandlerFunc(func(params actions.InvokeActionParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation ActionsInvokeAction has not yet been implemented")
		}),
		ActionsInvokeActionInPackageHandler: actions.InvokeActionInPackageHandlerFunc(func(params actions.InvokeActionInPackageParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation ActionsInvokeActionInPackage has not yet been implemented")
		}),
		RulesSetStateHandler: rules.SetStateHandlerFunc(func(params rules.SetStateParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation RulesSetState has not yet been implemented")
		}),
		ActionsUpdateActionHandler: actions.UpdateActionHandlerFunc(func(params actions.UpdateActionParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation ActionsUpdateAction has not yet been implemented")
		}),
		ActionsUpdateActionInPackageHandler: actions.UpdateActionInPackageHandlerFunc(func(params actions.UpdateActionInPackageParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation ActionsUpdateActionInPackage has not yet been implemented")
		}),
		PackagesUpdatePackageHandler: packages.UpdatePackageHandlerFunc(func(params packages.UpdatePackageParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation PackagesUpdatePackage has not yet been implemented")
		}),
		RulesUpdateRuleHandler: rules.UpdateRuleHandlerFunc(func(params rules.UpdateRuleParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation RulesUpdateRule has not yet been implemented")
		}),
		TriggersUpdateTriggerHandler: triggers.UpdateTriggerHandlerFunc(func(params triggers.UpdateTriggerParams, principal interface{}) middleware.Responder {
