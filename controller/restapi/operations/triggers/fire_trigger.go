...
type FireTriggerHandlerFunc func(FireTriggerParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn FireTriggerHandlerFunc) Handle(params FireTriggerParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// FireTriggerHandler interface for that can handle valid fire trigger params
type FireTriggerHandler interface {
	Handle(FireTriggerParams, interface{}) middleware.Responder
}
