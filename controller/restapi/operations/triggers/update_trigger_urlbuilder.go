...
func (o *UpdateTriggerURL) Build() (*url.URL, error) {
	...
	if namespace != "" {
		...
		return nil, errors.New("namespace is required on UpdateTriggerURL")
	}
	...
	if triggerName != "" {
		...
		return nil, errors.New("triggerName is required on UpdateTriggerURL")
	}
...
func (o *UpdateTriggerURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateTriggerURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateTriggerURL")
	}
