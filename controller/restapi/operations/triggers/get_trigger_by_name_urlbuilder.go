...
func (o *GetTriggerByNameURL) Build() (*url.URL, error) {
	...
	if namespace != "" {
		...
		return nil, errors.New("namespace is required on GetTriggerByNameURL")
	}
	...
	if triggerName != "" {
		...
		return nil, errors.New("triggerName is required on GetTriggerByNameURL")
	}
...
func (o *GetTriggerByNameURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetTriggerByNameURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetTriggerByNameURL")
	}
