...
type DeleteTriggerHandlerFunc func(DeleteTriggerParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteTriggerHandlerFunc) Handle(params DeleteTriggerParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// DeleteTriggerHandler interface for that can handle valid delete trigger params
type DeleteTriggerHandler interface {
	Handle(DeleteTriggerParams, interface{}) middleware.Responder
}
