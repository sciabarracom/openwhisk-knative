...
func (o *FireTriggerURL) Build() (*url.URL, error) {
	...
	if namespace != "" {
		...
		return nil, errors.New("namespace is required on FireTriggerURL")
	}
	...
	if triggerName != "" {
		...
		return nil, errors.New("triggerName is required on FireTriggerURL")
	}
...
func (o *FireTriggerURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on FireTriggerURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on FireTriggerURL")
	}
