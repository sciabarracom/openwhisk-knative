...
type GetAllPackagesHandlerFunc func(GetAllPackagesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetAllPackagesHandlerFunc) Handle(params GetAllPackagesParams, principal interface{}) middleware.Responder {
...
type GetAllPackagesHandler interface {
	Handle(GetAllPackagesParams, interface{}) middleware.Responder
}
