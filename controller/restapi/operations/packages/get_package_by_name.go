...
type GetPackageByNameHandlerFunc func(GetPackageByNameParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetPackageByNameHandlerFunc) Handle(params GetPackageByNameParams, principal interface{}) middleware.Responder {
...
type GetPackageByNameHandler interface {
	Handle(GetPackageByNameParams, interface{}) middleware.Responder
}
