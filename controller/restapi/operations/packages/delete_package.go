...
type DeletePackageHandlerFunc func(DeletePackageParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeletePackageHandlerFunc) Handle(params DeletePackageParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// DeletePackageHandler interface for that can handle valid delete package params
type DeletePackageHandler interface {
	Handle(DeletePackageParams, interface{}) middleware.Responder
}
