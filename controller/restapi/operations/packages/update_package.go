...
type UpdatePackageHandlerFunc func(UpdatePackageParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn UpdatePackageHandlerFunc) Handle(params UpdatePackageParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// UpdatePackageHandler interface for that can handle valid update package params
type UpdatePackageHandler interface {
	Handle(UpdatePackageParams, interface{}) middleware.Responder
}
