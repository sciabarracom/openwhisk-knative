...
// GetAllPackagesForbiddenCode is the HTTP code returned for type GetAllPackagesForbidden
const GetAllPackagesForbiddenCode int = 403

/*GetAllPackagesForbidden Unauthorized request

swagger:response getAllPackagesForbidden
*/
type GetAllPackagesForbidden struct {
...
// NewGetAllPackagesForbidden creates GetAllPackagesForbidden with default headers values
func NewGetAllPackagesForbidden() *GetAllPackagesForbidden {

	return &GetAllPackagesForbidden{}
}

// WithPayload adds the payload to the get all packages forbidden response
func (o *GetAllPackagesForbidden) WithPayload(payload *models.ErrorMessage) *GetAllPackagesForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get all packages forbidden response
func (o *GetAllPackagesForbidden) SetPayload(payload *models.ErrorMessage) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *GetAllPackagesForbidden) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
