...
func (o *GetRuleByNameURL) Build() (*url.URL, error) {
	...
	if namespace != "" {
		...
		return nil, errors.New("namespace is required on GetRuleByNameURL")
	}
	...
	if ruleName != "" {
		...
		return nil, errors.New("ruleName is required on GetRuleByNameURL")
	}
...
func (o *GetRuleByNameURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetRuleByNameURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetRuleByNameURL")
	}
