...
type DeleteRuleHandlerFunc func(DeleteRuleParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteRuleHandlerFunc) Handle(params DeleteRuleParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// DeleteRuleHandler interface for that can handle valid delete rule params
type DeleteRuleHandler interface {
	Handle(DeleteRuleParams, interface{}) middleware.Responder
}
