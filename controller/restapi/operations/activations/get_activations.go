...
type GetActivationsHandlerFunc func(GetActivationsParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetActivationsHandlerFunc) Handle(params GetActivationsParams, principal interface{}) middleware.Responder {
...
type GetActivationsHandler interface {
	Handle(GetActivationsParams, interface{}) middleware.Responder
}
