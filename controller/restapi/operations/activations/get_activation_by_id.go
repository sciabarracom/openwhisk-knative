...
type GetActivationByIDHandlerFunc func(GetActivationByIDParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetActivationByIDHandlerFunc) Handle(params GetActivationByIDParams, principal interface{}) middleware.Responder {
...
type GetActivationByIDHandler interface {
	Handle(GetActivationByIDParams, interface{}) middleware.Responder
}
